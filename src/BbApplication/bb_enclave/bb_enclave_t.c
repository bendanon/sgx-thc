...
static sgx_status_t SGX_CDECL sgx_bb_init_1(void* pms)
{
	...
	ms->ms_retval = bb_init_1(_in_sealed_data, _tmp_sealed_size, _in_bb_pk, _in_skg_pk, _tmp_pk_size, _in_p_report, _tmp_report_size, _in_config, _tmp_config_size);
err:
	if (_in_sealed_data) {

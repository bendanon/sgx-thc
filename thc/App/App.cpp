                                ...
                                sgx_sealed_data_t** pp_sealed_s_sk)
{
    ...
    sgx_status_t retval;
    status = skg_init(global_eid, &retval, _p_sealed_s_sk, SKG_DATA_SEALED_SIZE_BYTES, _p_skg_pk, pk_size);
...
int main(int argc, char const *argv[]) {
    ...
    ***/
    ...
    status = skg_initialization(&p_skg_pk, &p_sealed_s_sk);
    ...
    ***/
    ...
    status = bb_initialization_1(p_skg_pk, &p_bb_pk ,&p_sealed_k);
    ...
    ***/
    ...
    status = skg_execution(p_bb_pk, p_skg_pk, p_sealed_s_sk, s_encrypted);
